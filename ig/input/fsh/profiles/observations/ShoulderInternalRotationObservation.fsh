Profile: ShoulderInternalRotationObservation
Parent: ShoulderObservation
Id: shoulder-internal-rotation-observation
Title: "Shoulder Internal Rotation Active Range of Motion Observation"
Description: """
Observation documenting active shoulder internal rotation at the side
(adducted position), recorded by the "hand behind back" functional reach
test, the highest vertebral landmark the patient's hand can reach, on an
eight-tier ordinal (InternalRotationVertebralLevel). Covers expert consensus Q2.b
...
ShoulderInternalRotation90AbductionObservation.
...
"""
* ^url = "https://maxpurk.github.io/shoulder-on-fhir/StructureDefinition/shoulder-internal-rotation-observation"
* ^version = "0.2.0"
* ^status = #draft
* ^publisher = "Hasso Plattner Institute"
* ^date = "2026-07-19"
* code = ShoulderObservationCodes#internal-rotation
